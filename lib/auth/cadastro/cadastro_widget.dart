...
class _CadastroWidgetState extends State<CadastroWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.ref = valueOrDefault<String>(
        functions.getUserParams(),
        'gups',
      );
      safeSetState(() {});
      FFAppState().uRef = valueOrDefault<String>(
        functions.getUserParams(),
        'gup',
      );
      safeSetState(() {});
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<UsuarioRow>>(
      ...
      builder: (context, snapshot) {
        ...
        if (!snapshot.hasData) {
          return Scaffold(
            backgroundColor: const Color(0xFF135DF5),
            body: Center(
              child: SizedBox(
                width: 50.0,
                height: 50.0,
        ...
        List<UsuarioRow> cadastroUsuarioRowList = snapshot.data!;

        final cadastroUsuarioRow = cadastroUsuarioRowList.isNotEmpty
            ? cadastroUsuarioRowList.first
            : null;
                                                              ...
                                                              await UsuarioTable()
                                                                ...
                                                                'userRef':
                                                                    valueOrDefault<
                                                                        String>(
                                                                  _model.ref,
                                                                  '545f6cb0-d874-4d73-9b15-87084ff970e3',
                                                                ),
                                                                'created_at':
                                                                    supaSerialize<
                                                                            DateTime>(
