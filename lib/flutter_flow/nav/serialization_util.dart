    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case RelatorioRow:
            return RelatorioRow(data);
          case FinanceiroRow:
            return FinanceiroRow(data);
          case PropostasRow:
            return PropostasRow(data);
          case MensagensRow:
            return MensagensRow(data);
          case PendenciaRow:
            return PendenciaRow(data);
          case ProspectsRow:
            return ProspectsRow(data);
          case DocumentosRow:
            return DocumentosRow(data);
          case BannerRow:
            return BannerRow(data);
          case RespostasFormRow:
            return RespostasFormRow(data);
          case CursosRow:
