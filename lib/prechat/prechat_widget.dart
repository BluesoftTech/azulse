...
import 'prechat_model.dart';
export 'prechat_model.dart';

class PrechatWidget extends StatefulWidget {
  const PrechatWidget({super.key});

  @override
  State<PrechatWidget> createState() => _PrechatWidgetState();
}

class _PrechatWidgetState extends State<PrechatWidget> {
  late PrechatModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PrechatModel());
