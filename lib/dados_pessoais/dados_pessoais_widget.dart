...
class _DadosPessoaisWidgetState extends State<DadosPessoaisWidget> {
  ...
  void initState() {
    ...
    _model.cPFdconjugeTextController ??= TextEditingController();
    _model.cPFdconjugeFocusNode ??= FocusNode();
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<List<UsuarioRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<UsuarioRow> dadosPessoaisUsuarioRowList = snapshot.data!;

        final dadosPessoaisUsuarioRow = dadosPessoaisUsuarioRowList.isNotEmpty
                        ...
                        children: [
                            ...
                            child: Column(
                              ...
                              children: [
                                FlutterFlowDropDown<String>(
                                  controller:
                                      _model.estadoCivilValueController ??=
                                          FormFieldController<String>(null),
                                  options: const ['Solteiro', 'Casado'],
                                  onChanged: (val) => safeSetState(
                          ...
                          Padding(
                            ...
                            child: Column(
                              mainAxisSize: MainAxisSize.max,
                              children: [
                                if (_model.estadoCivilValue == 'Casado')
                                  Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 24.0, 0.0, 0.0),
                                    child: TextFormField(
                                      controller:
                                          _model.cPFdconjugeTextController,
                                      focusNode: _model.cPFdconjugeFocusNode,
                                      autofocus: true,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText: 'CPF do Conjuge',
                                        labelStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                              fontFamily: 'Readex Pro',
                                      ...
                                      keyboardType: TextInputType.number,
                                      validator: _model
                                          .cPFdconjugeTextControllerValidator
                                          .asValidator(context),
                                      inputFormatters: [_model.cPFdconjugeMask],
                                    ),
                                  ),
                                Padding(
                                  padding: const EdgeInsetsDirectional.fromSTEB(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                        ...
                                        () async {
                                          await UsuarioTable().update(
                                            data: {
                                              ...
                                              'CPFdoConjuge': int.tryParse(
                                                  _model
                                                      .cPFdconjugeTextController
                                                      .text),
                                            },
                                            matchingRows: (rows) =>
                                                rows.eqOrNull(
                                      ...
                                      context.goNamed('dadosEmpresariais');
